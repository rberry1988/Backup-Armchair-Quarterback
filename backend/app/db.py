...
def init_db():
    ...
    with engine.connect() as conn:
        ...
        _ensure_column(conn, "users", "webhook_url", "VARCHAR")
        ...
        _ensure_column(conn, "leagues", "fantasy_schedule", "JSON DEFAULT '{}'")
        _ensure_column(conn, "leagues", "activity", "JSON DEFAULT '{}'")
        _ensure_column(conn, "leagues", "notified", "JSON DEFAULT '{}'")
        _ensure_column(conn, "leagues", "uses_faab", "BOOLEAN NOT NULL DEFAULT 0")
        _ensure_column(conn, "leagues", "acquisition_budget", "INTEGER NOT NULL DEFAULT 0")
        _ensure_column(conn, "teams", "faab_spent", "FLOAT NOT NULL DEFAULT 0")
        _ensure_column(conn, "teams", "waiver_rank", "INTEGER")
        _ensure_column(conn, "teams", "acquisitions", "INTEGER NOT NULL DEFAULT 0")
        ...
        _ensure_column(conn, "leagues", "auto_sync_error", "VARCHAR")
